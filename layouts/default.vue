...
<template>
  <nav
      class="w-[100%] fixed top-0 left-0 max-sm:left-0 z-50 backdrop-blur border-b-2 dark:border-b-gray-800 border-b-gray-100">
    <div class="flex h-[60px] items-center flex-row pl-4 pr-4">
